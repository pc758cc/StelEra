...
import { CheckCircle, ArrowRight, Shield, Globe, Users, Zap, TrendingUp, CheckCircle2, Lightbulb } from "lucide-react"
...
export default function Home() {
  const featuredProducts = [
    ...
    },
    {
      ...
      description: "High-performance valves for precise valve control and automation systems.",
    },
    {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <h1 className="text-5xl lg:text-6xl xl:text-7xl font-bold text-primary leading-tight">
                  ...
                  <span className="block text-muted-foreground text-3xl lg:text-4xl font-normal mt-4">
                    for Tomorrow
                  </span>
                </h1>
              </div>
              ...
              <p className="text-xl text-muted-foreground leading-relaxed max-w-xl">
                Precision-engineered industrial components designed for reliability, performance, and sustainability
            ...
            <div className="relative h-96 lg:h-[500px] rounded-2xl overflow-hidden shadow-2xl">
              <img src="/Hero Image 1.jpg" alt="Industrial Solutions" className="w-full h-full object-cover" />
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12">
            <div className="space-y-2">
              <div className="text-4xl lg:text-5xl font-bold">20+</div>
            ...
            <div className="space-y-2">
              <div className="text-4xl lg:text-5xl font-bold">1000+</div>
              <p className="text-white/80">Projects Delivered</p>
              <div className="h-1 w-12 bg-accent mt-4"></div>
            </div>
            <div className="space-y-2">
              <div className="text-4xl lg:text-5xl font-bold">99.8%</div>
        ...
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="relative h-80 lg:h-[450px] rounded-xl overflow-hidden shadow-xl">
              <img src="/Manufacturing Facility.jpg" alt="Manufacturing" className="w-full h-full object-cover" />
            </div>
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <h2 className="text-4xl lg:text-5xl font-bold text-primary">Engineered for Excellence</h2>
                <p className="text-lg text-muted-foreground leading-relaxed">
                  We design and manufacture industrial valves, pipes, and components that set global standards. Our
                  commitment to precision, innovation, and reliability has made us a trusted partner across 50+
                  countries.
                </p>
              </div>
              ...
              <Link href="/about-us">
                <Button className="bg-accent hover:bg-accent/90 text-white px-6 py-3 rounded-lg">Learn More</Button>
              </Link>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold text-primary mb-4">What We Offer</h2>
            ...
            {[
              {
                ...
                description: "Engineered to exacting specifications and quality standards",
              },
              {
                icon: Lightbulb,
                title: "Innovation",
              ...
              },
              {
                icon: Globe,
                title: "Global Reach",
                description: "Serving industries worldwide with local expertise",
              },
              {
                icon: Users,
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold text-primary mb-4">Industries We Serve</h2>
      ...
      <section className="py-20 bg-gradient-to-r from-primary to-primary/80 text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Connect with our expert team to discuss your industrial requirements and find the perfect solution.
          </p>
          <Link href="/contact-us">
            <Button size="lg" className="bg-accent hover:bg-accent/90 text-white px-10 py-6 text-lg rounded-lg">
              Get in Touch
              <ArrowRight className="ml-2 w-5 h-5" />
            </Button>
          </Link>
          ...
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <div className="space-y-2 text-white/80">
                <p>+91 8269922916</p>
                <p>blackspec.engineering@gmail.com</p>
                <p>Sector 28, Naya Raipur</p>
                <p>Chhattisgarh, India</p>
              </div>
            </div>
          </div>
          <div className="border-t border-white/20 pt-8 text-center text-white/60">
            <p>&copy; 2025 Industrial Solutions. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
